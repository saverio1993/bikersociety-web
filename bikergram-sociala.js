(() => {
  ...
  const css = `
    ...
    .bs-gram-text{padding:0 14px 13px;color:#eef1f6;font-size:14px;line-height:1.48;white-space:pre-wrap}.bs-gram-media{background:#050607}.bs-gram-media img,.bs-gram-media video{display:block;width:100%;max-height:520px;object-fit:cover}.bs-gram-media audio{width:calc(100% - 28px);margin:14px}
